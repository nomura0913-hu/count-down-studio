  ...
  return (
    <div className="flex flex-col h-full w-full" style={{
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            style={{ color: "#a8a8a0", background: "#1a1a18", border: "1px solid #2a2a24" }}
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            style={{
              background: showingEventInfo ? "#c186c8" : "#1a1a18",
              border: showingEventInfo ? "1px solid #c186c8" : "1px solid #2a2a24",
          ...
          <input
            ...
            style={{ background: "#1a1a18", border: "1px solid #2a2a24", color: "#e8e8e2", fontFamily: UI_FONT }}
          ...
          <input
            type="text"
            inputMode="numeric"
            className="h-9 text-sm rounded-lg px-2 text-center font-semibold placeholder:text-[#76766f] focus:outline-none focus:ring-1 focus:ring-[#2a2a24] transition-all duration-150"
            style={{ width: "72px", minWidth: "72px", background: "#1a1a18", border: "1px solid #2a2a24", color: "#e8e8e2", fontFamily: MONO_FONT }}
      ...
      {/* LEFT: External display preview area.
          Outer container is WARM GRAY (#141411). ONLY the 16:9 preview rectangle is pure BLACK.
      ...
      >
        ...
        <div className="flex-1 min-h-[16px]" style={{ background: "#141411" }} />

        {/* 16:9 preview rectangle — ONLY this is pure black, capped so it never overflows */}
        <div className="px-6 w-full shrink-0" style={{ background: "#141411" }}>
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              borderRadius: "6px",
              boxShadow: "0 8px 32px rgba(0,0,0,0.6), 0 0 0 1px #2a2a24",
            }}
          >
            {showingEventInfo ? (
              <EventInfoDisplay
        ...
        >
          ...
          {countdownStatus === "running" && (
            <button onClick={onPause} className={ctrlBtnClass}
              style={{ color: "#e8e8e2", background: "#1a1a18", border: "1px solid #2a2a24" }}
      ...
      >
        ...
        <div ref={editorScrollRef} className="flex-1 overflow-y-scroll min-h-0">
          <div className="sticky top-0 z-20" style={{ background: "#141411" }}>
