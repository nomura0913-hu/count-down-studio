...
export default function Manage() {
  ...
  if (outputOpen) {
    return (
      <div className="flex flex-col h-full w-full bg-[#141411] overflow-hidden" data-testid="show-page">
  ...
  return (
    <div
      ...
      style={{
        fontFamily: UI_FONT,
        background: "#141411", // warm gray canvas; header strip (deep black) creates contrast
      }}
    ...
    >
      ...
      <div
        ...
        style={{
          height: 56,
          background: "#141411",                      // deeper than canvas for strong anchor
          ...
          <div className="max-w-7xl mx-auto px-3 pt-4 pb-0">
            ...
            <div className="flex items-center gap-2 mb-3">
              <button
                ...
                style={{ background: "#141411", border: "1px solid #1e1e1c" }}
